...
import { citiesList, data, type Person, usStateList } from '../mock/filterData';
...
const FilterTableExample = () => {
  ...
  const table = useMaterialReactTable({
    columns,
    data,
    initialState: { showColumnFilters: true,columnVisibility: { hireDate: false }  },
  });
...
const FilterTableExampleProvider = () => (
  <LocalizationProvider dateAdapter={AdapterDayjs}>
    <FilterTableExample />
  </LocalizationProvider>
);

export default FilterTableExampleProvider;
